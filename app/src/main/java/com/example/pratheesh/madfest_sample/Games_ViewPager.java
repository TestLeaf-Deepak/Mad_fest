...
public class Games_ViewPager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_games__view_pager);

        Typeface typeface=Typeface.createFromAsset(getAssets(),"Fonts/OpenSans-Regular.ttf");

        toolbar=(Toolbar)findViewById(R.id.games_viewpager_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(null);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        games_toolbar=(TextView)findViewById(R.id.games_toolbar_textview);
        games_toolbar.setTypeface(typeface);

        viewPager=(ViewPager)findViewById(R.id.games_viewpager);
        setupViewPager(viewPager);



        tabLayout=(TabLayout)findViewById(R.id.games_tablayout);
    ...
    private void setupViewPager(ViewPager viewPager)
    {
        ...
        adapter.addFragment(new Games());
        adapter.addFragment(new games_banglore());
        adapter.addFragment(new games_pune());

...
public class Points_Table_ViewPager extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_points__table__view_pager);

        Typeface typeface=Typeface.createFromAsset(getAssets(),"Fonts/OpenSans-Regular.ttf");

        toolbar=(Toolbar)findViewById(R.id.points_viewpager_toolbar);
        setSupportActionBar(toolbar);
        getSupportActionBar().setTitle(null);
        getSupportActionBar().setDisplayHomeAsUpEnabled(true);

        games_toolbar=(TextView)findViewById(R.id.points_toolbar_textview);
        games_toolbar.setTypeface(typeface);

        viewPager=(ViewPager)findViewById(R.id.points_viewpager);
        setupViewPager(viewPager);



        tabLayout=(TabLayout)findViewById(R.id.points_tablayout);
    ...
    private void setupViewPager(ViewPager viewPager)
    {
        ...
        adapter.addFragment(new points_table());
        adapter.addFragment(new Points_Table_banglore());
        adapter.addFragment(new Points_Table_Pune());
